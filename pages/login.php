  ...
  <div class="page">
    ...
    <main class="main">
      <div class="container">
        ...
        ?>
          <form class="singup-form" method="POST" action="login.php">
            <?php
            if ($err == true) {
              echo "<p class='wrong'>Введений логін або пароль не вірний</p>";
            }
            ?>
            <p>Введіть логін</p>
        ...
        ?>
          <p class="congrat">Вітаю,<?php echo $_SESSION['user']['0']['login'] ?>, ви успішно увійшли!</p>
        <?php
        }
        ?>
      </div>
