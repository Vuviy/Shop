      ...
      <div class="container">
        ...
        if (isset($data['do_singup'])) {
          if ($password2 == $password) {
            ...
            while ($res = mysqli_fetch_assoc($user_id)) {
              $user_info = ['id' => $res['id']];
            }
            ...
            array_push($_SESSION['user'], $user_info);
        ...
        ?>
          ...
          <form class="singup-form" method="POST" action="signup.php">
            ...
            if (isset($data['do_singup']) and $password2 !== $password) {
            ?>
              <p class="wrong-text">Повторно введений пароль невірний</p>
              <p><input class="bbb" type="password" name="password2"></p>
            <?php
            }
            ?>
            <button type="submit" name="do_singup">Зареєструватись</button>
        ...
        ?>
          <p class="congrat">Вітаю,<?php echo $_SESSION['user']['0']['login'] ?>, ви успішно зареєстровані!</p>
