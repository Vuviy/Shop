          ...
          <div class="container">
            <div class="main-inner">
              <section class="slider">
                <div class="slider-body">
                  <div class="treck">
                    <div class="item">
                      <a href="pages/categorie.php?categorie=14">
                        <img src="../img/per1.webp" alt="">
                      </a>
                    </div>
                    <div class="item">
                      <a href="pages/categorie.php?categorie=15">
                        <img src="../img/per2.webp" alt="">
                      </a>
                    </div>
                    <div class="item">
                      <a href="pages/categorie.php?categorie=13">
                        <img src="../img/per3.webp" alt="">
                      </a>
                    </div>
            ...
            <div class="row">
              <section class="top-sales">
                <h2 class="section-title">Топ продажів</h2>
                <div class="top-sales-cards">


                  <?php
                  $query_top = "SELECT * FROM `goods` ORDER BY `views` DESC LIMIT 4";
                  $query_top_items = mysqli_query($conn, $query_top);
                  while ($query_top_item = mysqli_fetch_assoc($query_top_items)) {
                  ?>

                    <div id="form<?php echo $query_top_item['id'] ?>" class="card-item">
                      <div class="card-photo">
                        <a href="pages/goods.php?id=<?php echo $query_top_item['id'] ?>">
                          <img src="../img/dress/<?php echo $query_top_item['photo'] ?>" alt="">
                        </a>
                      </div>
                      <div class="info-card">
                        <h2>
                          <?php echo mb_substr($query_top_item['title'], 0, 15) ?>
                        </h2>

                        <div class="info-info">
                          <span class="price">
                            <?php echo $query_top_item['price'] ?><span>грн</span>
                          </span>
                          <span class="sizes">
                            <?php echo $query_top_item['size'] ?>
                          </span>
                        </div>

                        <a href="pages/goods.php?id=<?php echo $query_top_item['id'] ?>"><button class="buy-btn">купити</button></a>
                      </div>
                    </div>
            ...
            <div class="row">
              <section class="top-sales">
                ...
                <div class="top-sales-cards">
                  <?php
                  $query_sale = "SELECT * FROM `goods` WHERE `sale` = 'true'";
                  $query_sale_items = mysqli_query($conn, $query_sale);

                  while ($query_sale_item = mysqli_fetch_assoc($query_sale_items)) {
                  ?>
                    <div class="card-item">
                      <div class="card-photo">
                        <a href="pages/goods.php?id=<?php echo $query_sale_item['id'] ?>">
                          <img src="../img/dress/<?php echo $query_sale_item['photo'] ?>" alt="">
                        </a>
                      </div>
                      <div class="info-card">
                        <h2>
                          <?php echo mb_substr($query_sale_item['title'], 0, 15) ?>
                        </h2>

                        <div class="info-info">
                          <span class="price">
                            <?php echo $query_sale_item['price'] ?><span>грн</span>
                          </span>
                          <span class="sizes">
                            <?php echo $query_sale_item['size'] ?>
                          </span>
                        </div>
                        <a href="pages/goods.php?id=<?php echo $query_sale_item['id'] ?>"><button class="buy-btn">купити</button></a>
                      </div>
                    </div>
